I need to read the test result images to extract the data for the table. Let me first find the image files in the test directory and then read them.

Now let me read these test result images to extract the performance data:

I can see the test result images showing performance data. Based on the images, I can extract the following information:

**200 Jobs Test (3 workers for convert, 1 each for others):**
- Duration: ~46.6s
- Throughput: ~4.29 jobs/sec
- Success: 200 jobs
- Failed: 0
- Average response time: ~11,679ms
- Percentiles: P50: ~11,289ms, P75: ~14,617ms, P90: ~16,755ms, P95: ~19,639ms, P99: ~22,534ms

**500 Jobs Test (3 workers for convert, 1 each for others):**
- Duration: ~116.5s
- Throughput: ~4.29 jobs/sec
- Success: 433 jobs (86.6% success rate)
- Failed: 67 jobs (13.4% failure rate)
- Average response time: ~11,479ms
- Percentiles: P50: ~11,089ms, P75: ~14,617ms, P90: ~16,755ms, P95: ~19,639ms, P99: ~22,534ms

Now let me provide the updated README with this data integrated into the performance table:
